...
namespace RKernel.Applications
{
    public static class Notepad
    {
        ...
        public static string Editor(string[] argv)
        {
            ...
            if (argv[1] == "--help") { Console.Write("Notepad is basic RKernel application for coding on languages like HSharp and HyperAssembly."); }
            else
            {
                if (!argv[1].StartsWith(CurrentDir))
                {
                    argv[1] = CurrentDir + argv[1];
                }
                PATH = argv[1];
            }
        ...
        public static void Drw(string PATH, string tosav, string arrow, string old)
        {
            ...
            Console.SetCursorPosition(0, 0);
            Console.Write($"RKernel: {ver}: " + @PATH);
            ...
            if (oldrep != null)
            {
                ...
                if (newrep != null)
                {
                    ...
                    else
                    {
                        ...
                        Console.Write("CANNOT FIND WORD TO REPLACE!");
                        Console.ReadKey();
                    }
                }
